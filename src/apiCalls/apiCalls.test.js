...
describe('getBeerByYeast', () => {
  ...
  it('should call fetch with the correct url', () => {
    getBeerByYeast('Wyeast_3711');

    expect(window.fetch).toHaveBeenCalledWith(
      'https://api.punkapi.com/v2/beers?yeast=Wyeast_3711'
    );
  });

  it('should return an array of beer objects', () => {
    expect(getBeerByYeast('Wyeast_3711')).resolves.toEqual(mockResponse);
  });
  ...
  it('should return an error if the response is not okay', () => {
    ...
    expect(getBeerByYeast('Wyeast_3711')).rejects.toEqual(
      Error('Could not retrieve beers, please explore with us later.')
    );
  });
